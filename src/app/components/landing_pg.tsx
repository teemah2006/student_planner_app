    ...
    return (
        <div className="grid lg:grid-cols-2 lg:grid-rows-none grid-rows-2 lg:justify-items-between  w-full min-h-screen md:gap-16 gap-10">
            ...
            <div id="description" className="lg:my-auto mb-2 lg:mx-auto mx-4">
                <h2 className="text-[25px] lg:text-[40px] md:text-[35px] font-bold"><span className="text-black">Maximize your study time with</span> <br /> <span className="text-blue-700">AI-powered planning!</span></h2>
                ...
                <div className=" w-[100%] flex justify-center mt-4 lg:mt-6">
                    <button className="lg:p-4 p-[12px] md:p-[15px] bg-blue-700 rounded-xl lg:mt-12  cursor-pointer font-bold hover:bg-blue-900 "
