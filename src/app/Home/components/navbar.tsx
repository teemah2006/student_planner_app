...
export default function Navbar() {
    ...
    const LinkClasses = " block border-transparent  text-sm  md:text-lg   border hover:border-blue-100 rounded flex gap-2 md:flex-row flex-col  items-center p-[2px] md:p-2 transition "
    const Links = (
        <>
            ...
            <Link href="/authentication" onClick={() => signOut()} className={LinkClasses + ' text-gray-100 flex-row'}><FaArrowRightFromBracket />Log Out</Link>
